 ...
 */
@Autonomous(name = "New Auto Front Blue")
public class NewAutoFrontBlue extends CommandOpMode {
...
//        statePa1thUpdate();
        if (!robot.follower.isBusy()) robot.follower.followPath(paths.MainChain);
